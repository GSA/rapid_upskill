...
All of [Stage 1](stage-1/index.md) through [Stage 4](stage-4/index.md) are now published and use some of these files; other pages are planned and are not published yet, so this list does not link to them. Page titles may change.

- Blueprint: [S1.3 Draft the blueprint](stage-1/blueprint.md) checks it with a sample script. [S1.8 Coverage and gaps](stage-1/coverage-and-gaps.md) finds the gap at D4.2. [S1.7 Concept map and prerequisite hierarchy](stage-1/concept-map-and-hierarchy.md) assigns and checks the same kind of tier the blueprint already carries for each objective. [S2.1 Structural drafting](stage-2/structural-drafting.md) drafts Chapter 1 from its own four objectives, D1.1, D1.2, D1.3 and D2.1. The stem-planning and difficulty pages (Stage 5, planned) will use the bank size, the difficulty split and the weights.
- D2.3 and SRC-003: [S4.1 and S4.2 Principles and protocol library](stage-4/principles-and-protocol-library.md) walks its four-level hint ladder through this objective's own merge-conflict scenario.
- All seven sources: [S3.4 and S3.5 Source tiering and remediation](stage-3/tiering-and-remediation.md) gives each one this guide's own suggested credibility tier, drawn from this page's own descriptions below.
- SRC-001, SRC-002 and SRC-006: [S3.1 Layer 1 automated detection](stage-3/layer-1-automated-detection.md) and [S3.3 Layer 3 audit trail](stage-3/layer-3-audit-trail.md) use them as the sources behind a small set of sample claims and citations.
- SRC-002: [S1.5a Concept extraction](stage-1/concept-extraction.md) and [S1.5b Distillate and quote bank](stage-1/distillate-and-quote-bank.md) use it as a sample source. One of its "common mistake" sentences also feeds [S4.5 Misconception catalog and error diagnosis](stage-4/misconception-catalog-and-error-diagnosis.md)'s own illustrative example, a suggested reading this guide built fresh, not a sourced link; the [distractor](glossary.md#distractor) pages (Stage 5, planned) will draw on this same kind of sentence separately.
