---
title: "P-CA-01 Propose a study schedule"
parent: "Certification alignment prompts"
grand_parent: "Prompt library"
nav_order: 1
generated: true
---
<!-- GENERATED by scripts/site/sync.py from prompts/ca/propose-a-study-schedule.md. Do not edit. -->
{% raw %}

# P-CA-01 Propose a study schedule
...
| Outputs | A proposed reading\_minutes, active\_minutes and total\_minutes for the chapter, in the shape schedule\_check.py reads, plus a one-line rationale. |
| Needs | `llm`, `file-read` |
...
| Source | [prompts/ca/propose-a-study-schedule.md](https://github.com/GSA/rapid_upskill/blob/master/prompts/ca/propose-a-study-schedule.md) |
