---
title: "P-DL-01 Draft slide content and a presenter script"
parent: "Delivery prompts"
grand_parent: "Prompt library"
nav_order: 1
generated: true
---
<!-- GENERATED by scripts/site/sync.py from prompts/dl/draft-slide-content-and-script.md. Do not edit. -->
{% raw %}

# P-DL-01 Draft slide content and a presenter script
...
| Outputs | One slide-notes Markdown file for the chapter, in the format slide\_notes\_check.py checks: a chapter heading, one or more numbered slide sections each with 4 to 7 flat bullets, and a bolded presenter-script block of 150 to 250 words per slide. |
| Needs | `llm`, `file-read` |
...
| Source | [prompts/dl/draft-slide-content-and-script.md](https://github.com/GSA/rapid_upskill/blob/master/prompts/dl/draft-slide-content-and-script.md) |
